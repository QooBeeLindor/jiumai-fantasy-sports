...
class NBAEloSystem:
    ...
    def adjust_11cat_score(self, score1, score2, num_categories=11):
        """
        调整11-cat联赛的比分以反映平局
    ...
    def update_elo_ratings(self):
        ...
        for match in matches:
            match_id, mgr1_id, score1_raw, mgr2_id, score2_raw = match
            
            # 调整11-cat平局
            score1, score2, num_ties = self.adjust_11cat_score(score1_raw, score2_raw)
        ...
        print(f"✅ 已处理 {len(matches)} 场比赛（使用11-cat平局调整）")
                        ...
                        for matchup_key, matchup_wrapper in matchups_dict.items():
                            ...
                            if teams_dict and '0' in teams_dict and '1' in teams_dict:
                                ...
                                if team1_key and team2_key and team1_key in team_managers and team2_key in team_managers:
                                    ...
                                    # 确定结果（使用调整后的比分判断）
                                    adj_score1, adj_score2, _ = self.adjust_11cat_score(team1_score, team2_score)
...
def main():
    """主函数"""
    print("=" * 60)
    print("🏀 NBA Fantasy ELO Rating System V2.1")
    print("=" * 60)
    ...
    if choice == '1':
        ...
        print("\n🔬 测试Yahoo API阵容功能...")
        print("此功能将在完整版本中实现")
        print("需要获取league对象和team对象才能调用roster()方法")
    elif choice == '5':
        print("\n👋 再见!")
    else:
        print("\n❌ 无效选项")
